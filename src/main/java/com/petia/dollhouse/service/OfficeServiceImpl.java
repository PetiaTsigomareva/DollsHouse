...
public class OfficeServiceImpl implements OfficeService {
    ...
    public OfficeServiceModel editOffice(OfficeServiceModel model) {
        ...
        Office mappedOffice = this.officeRepository.saveAndFlush(this.modelMapper.map(model, Office.class));
        mappedOffice.setStatus(office.getStatus());
        mappedOffice.setCompany(company);
