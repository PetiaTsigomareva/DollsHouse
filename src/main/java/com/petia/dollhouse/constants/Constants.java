...
public interface Constants {
    ...
    public static final String ERROR_NOT_FOUND_PAGE = "/error/not-found-error";
    public static final String ERROR_GENERAL_PAGE = "/error/general-error";
    ...
    public static final String ERROR_MESSAGE_TITLE = "error-message";
